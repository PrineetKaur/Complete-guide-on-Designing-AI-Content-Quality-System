...
This guide explains how product teams can use the Tone Consistency System.
...
Use the Tone Evaluation Prompt from `prompts.md`
...
Apply suggestions or use the Tone Improvement Prompt
...
2. Designer reviews using prompt  
...
- Use system principles as the source of truth  
...
This system is not meant to replace content designers.
